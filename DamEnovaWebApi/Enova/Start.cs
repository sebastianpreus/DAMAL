...
namespace DamEnovaWebApi.Enova
{
    public static class Start
    {
        ...
        static public void LoadLibraries()
        {
            ...
            typeof(Soneta.Start.Loader).GetField("assemblyPath", BindingFlags.Static | BindingFlags.NonPublic).SetValue(null, @"C:\Program Files (x86)\Soneta\enova365 2112.5.7.0");
