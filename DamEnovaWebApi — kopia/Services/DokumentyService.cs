...
namespace DamEnovaWebApi.Services
{
    ...
    {
        public void PostDokument(DamDokument damDokument)
        {
            //////////////////////////////////////////////////////////////////
            ...
            using (Session session = Connection.enovalogin.CreateSession(false, false))
            {
                ...
                using (ITransaction trans = session.Logout(true))
                {
                    ...
                    // wg jej symbolu "PZ".
                    //
                    DefDokHandlowego definicja = hm.DefDokHandlowych.WgSymbolu[damDokument.Symbol]; //"PZ 2"
                    if (definicja == null)
                        throw new InvalidOperationException("Nieznaleziona definicja dokumentu " + damDokument.Symbol + ".");
                    ...
                    Kontrahent kontrahent = cm.Kontrahenci.WgKodu[damDokument.KodKontrahenta]; //"FLEETCOR SK"
                    if (kontrahent == null)
                        throw new InvalidOperationException("Nieznaleziony kontrahent o kodzie " + damDokument.KodKontrahenta + ".");
                    ...
                    Towar towar = (Towar)tm.Towary.WgEAN[damDokument.EAN].GetNext();
                    if (towar != null)
                    {
                        //////////////////////////////////////////////////////////////
                        ...
                        //
                        pozycja.Ilosc = new Quantity(damDokument.Ilosc, null);
                        ...
                        //
                        pozycja.Cena = new DoubleCy(damDokument.Cena);
